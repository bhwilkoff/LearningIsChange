---
title: "Launching #C4C15: Comments for Community in 2015"
date: 2014-12-27
url: https://learningischange.com/2014/12/27/c4c15/
author: Ben Wilkoff
...
- I will use [Nuzzel](http://nuzzel.com/) to find the posts that have the most re-tweets every day. I will use [Feedly](http://feedly.com/) to curate my favorite blogs. I will use [Flipboard](https://about.flipboard.com/), [Zite](http://zite.com/), and [Google+](http://zite.com/) to find articles that are off the beaten path.
- I will use [this IFTTT recipe](https://ifttt.com/recipes/233578-c4c15-recipe) to send all of my favorites to [a Google Doc that will have the list of all of the posts](https://docs.google.com/document/d/1hfaBf554af1ktVom764AGIaXOE8ohdffz5zuVq1NqS8/edit) I want to comment on.
- I will use the comment feature on the post.
- I will highlight the comment after it is posted and the use the [“Press This” bookmarklet](http://en.support.wordpress.com/press-this/) to capture it back to this blog.
